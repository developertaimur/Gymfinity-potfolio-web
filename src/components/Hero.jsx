                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div className="max-w-xl">
                        ...
                        <div className="mt-8 flex flex-col sm:flex-row gap-4">
                            <a
                                href="#contact"
                                className="group inline-flex items-center justify-center gap-2 px-7 py-3.5 bg-gymfinity-400 text-white font-semibold rounded-full hover:bg-gymfinity-600 transition-all duration-300 shadow-lg shadow-gymfinity-400/25 hover:shadow-xl hover:shadow-gymfinity-400/30 hover:-translate-y-0.5"
                            >
                            ...
                            <a
                                href="#contact"
                                className="group inline-flex items-center justify-center gap-2 px-7 py-3.5 border-2 border-gymfinity-400 text-gymfinity-400 font-semibold rounded-full hover:bg-gymfinity-400 hover:text-white transition-all duration-300 hover:-translate-y-0.5"
                            >
