...
//               {/* Title */}
//               <h4 className="text-xl font-semibold text-gymfinity-400 group-hover:text-white transition-colors duration-300 mb-3">
//                 {item.title}
//               </h4>

//               {/* Text */}
//               <p className="text-gray-500 group-hover:text-gray-200 transition-colors duration-300 mb-6 text-sm leading-relaxed">
//                 {item.review}
//               </p>
...
//                 src={item.image}
//                 alt={item.name}
//                 className="w-20 h-20 rounded-full mx-auto border-2 border-gymfinity-400 group-hover:border-white transition duration-300 mb-3"
//               />

//               {/* Name */}
//               <h5 className="text-lg font-semibold text-gymfinity-400 group-hover:text-white transition duration-300">
//                 {item.name}
//               </h5>

//               {/* Role */}
//               <h6 className="text-sm text-gray-500 group-hover:text-gray-200 transition duration-300">
//                 {item.role}
//               </h6>
